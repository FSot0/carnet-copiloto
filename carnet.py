...
PUNTOS = "15/15"
PROGRESO = 100
FOTO_URL = "https://i.imgur.com/jyJdpBB.jpeg"  # si pones foto, usa link DIRECTO a .jpg/.png
...
st.markdown(
    dedent("""
    <style>
      .wrap { max-width: 420px; margin: 0 auto; padding: 6px 10px 18px 10px; }
      .card {
        border-radius: 22px;
...
photo_html = f"<img class='photo' src='{FOTO_URL}'/>" if FOTO_URL else ""
